...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // checkLoginStatus() sudah tidak diperlukan di sini,
    // karena sudah ditangani oleh AuthCheck di main.dart.
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // Bagian 1: Latar belakang biru, tetap sama
          Container(
          ...
          // Menggunakan LayoutBuilder dan ConstrainedBox untuk mendorong konten ke bawah.
          SafeArea(
            child: LayoutBuilder(
                ...
                return SingleChildScrollView(
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      mainAxisAlignment:
                          MainAxisAlignment
                              .spaceBetween, // Mendorong konten ke atas dan bawah
                      children: [
                        // --- KONTEN BAGIAN ATAS (BIRU) ---
                        // Konten ini akan menempel di atas
                        Container(
                          width: double.infinity,
                        ...
                        // Konten ini akan menempel di bawah
                        Container(
