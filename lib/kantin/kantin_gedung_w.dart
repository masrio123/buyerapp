...
class KantinGedungW extends StatefulWidget {
  ...
  const KantinGedungW({Key? key, required this.cart, required this.onCartUpdated}) : super(key: key);

  @override
  State<KantinGedungW> createState() => _KantinGedungTState();
}

class _KantinGedungTState extends State<KantinGedungW> {
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => VendorMenuGedungWPage(
                              vendorName: name,
                              cart: widget.cart,
...
class _VendorMenuGedungWPageState extends State<VendorMenuGedungWPage> {
  static final Map<String, Map<String, List<Map<String, dynamic>>>> kantinGedungWMenu = {
    'Ndokee Express': {
      'Nasi Goreng': [
  ...
  @override
  Widget build(BuildContext context) {
    final vendorMenus = kantinGedungWMenu[widget.vendorName]!;
